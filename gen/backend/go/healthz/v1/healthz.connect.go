...
const (
	...
	HealthzServiceName = "healthz.v1.HealthzService"
)
...
const (
	...
	HealthzServiceGetPingProcedure = "/healthz.v1.HealthzService/GetPing"
	// HealthzServiceGetStatusProcedure is the fully-qualified name of the HealthzService's GetStatus
	// RPC.
	HealthzServiceGetStatusProcedure = "/healthz.v1.HealthzService/GetStatus"
)

// HealthzServiceClient is a client for the healthz.v1.HealthzService service.
...
// NewHealthzServiceClient constructs a client for the healthz.v1.HealthzService service. By
...
func NewHealthzServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthzServiceClient {
	...
	healthzServiceMethods := File_healthz_v1_healthz_proto.Services().ByName("HealthzService").Methods()
...
// GetPing calls healthz.v1.HealthzService.GetPing.
...
// GetStatus calls healthz.v1.HealthzService.GetStatus.
...
// HealthzServiceHandler is an implementation of the healthz.v1.HealthzService service.
...
func NewHealthzServiceHandler(svc HealthzServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/healthz.v1.HealthzService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthzServiceHandler) GetPing(context.Context, *connect.Request[GetPingRequest]) (*connect.Response[GetPingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("healthz.v1.HealthzService.GetPing is not implemented"))
}
...
func (UnimplementedHealthzServiceHandler) GetStatus(context.Context, *connect.Request[GetStatusRequest]) (*connect.Response[GetStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("healthz.v1.HealthzService.GetStatus is not implemented"))
}
