...
const (
	...
	AuthServiceRegisterUserInfoProcedure = "/auth.v1.AuthService/RegisterUserInfo"
	...
	AuthServiceCompleteRegistrationProcedure = "/auth.v1.AuthService/CompleteRegistration"
	// AuthServiceCheckUsernameAvailableProcedure is the fully-qualified name of the AuthService's
	// CheckUsernameAvailable RPC.
	AuthServiceCheckUsernameAvailableProcedure = "/auth.v1.AuthService/CheckUsernameAvailable"
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := File_auth_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// CompleteRegistration calls auth.v1.AuthService.CompleteRegistration.
...
// CheckUsernameAvailable calls auth.v1.AuthService.CheckUsernameAvailable.
...
func (UnimplementedAuthServiceHandler) RegisterUserInfo(context.Context, *connect.Request[RegisterUserInfoRequest]) (*connect.Response[RegisterUserInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("auth.v1.AuthService.RegisterUserInfo is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) CompleteRegistration(context.Context, *connect.Request[CompleteRegistrationRequest]) (*connect.Response[CompleteRegistrationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("auth.v1.AuthService.CompleteRegistration is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) CheckUsernameAvailable(context.Context, *connect.Request[CheckUsernameAvailableRequest]) (*connect.Response[CheckUsernameAvailableResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("auth.v1.AuthService.CheckUsernameAvailable is not implemented"))
}
