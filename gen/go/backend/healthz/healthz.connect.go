...
const (
	...
	HealthzServiceName = "backend.healthz.HealthzService"
)
...
const (
	...
	HealthzServiceGetPingProcedure = "/backend.healthz.HealthzService/GetPing"
	// HealthzServiceGetStatusProcedure is the fully-qualified name of the HealthzService's GetStatus
	// RPC.
	HealthzServiceGetStatusProcedure = "/backend.healthz.HealthzService/GetStatus"
)

// HealthzServiceClient is a client for the backend.healthz.HealthzService service.
...
// NewHealthzServiceClient constructs a client for the backend.healthz.HealthzService service. By
...
func NewHealthzServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthzServiceClient {
	...
	healthzServiceMethods := File_backend_healthz_healthz_proto.Services().ByName("HealthzService").Methods()
...
// GetPing calls backend.healthz.HealthzService.GetPing.
...
// GetStatus calls backend.healthz.HealthzService.GetStatus.
...
// HealthzServiceHandler is an implementation of the backend.healthz.HealthzService service.
...
func NewHealthzServiceHandler(svc HealthzServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/backend.healthz.HealthzService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthzServiceHandler) GetPing(context.Context, *connect.Request[GetPingRequest]) (*connect.Response[GetPingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("backend.healthz.HealthzService.GetPing is not implemented"))
}
...
func (UnimplementedHealthzServiceHandler) GetStatus(context.Context, *connect.Request[GetStatusRequest]) (*connect.Response[GetStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("backend.healthz.HealthzService.GetStatus is not implemented"))
}
